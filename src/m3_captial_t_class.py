...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        # nit__(self, intersection_center, width, height, letter_thickness):

        self.center = intersection_center

        uplefthoriz = rg.Point(self.center.x - width / 2, self.center.y - letter_thickness/2)
        lowrighthoriz = rg.Point(self.center.x + width / 2, self.center.y + letter_thickness/2)
        self.h_rect = rg.Rectangle(uplefthoriz, lowrighthoriz)

        upleftvert = rg.Point(self.center.x - letter_thickness / 2, self.center.y - letter_thickness / 2)
        lowrightvert = rg.Point(self.center.x + letter_thickness / 2, (self.center.y - letter_thickness / 2) + height)
        self.v_rect = rg.Rectangle(upleftvert, lowrightvert)
    ...
    def set_colors(self, fill_color, outline_color):
        ...
        #     set_colors.pdf.
        # --------------------------------------------------------------
        # set_colors(self, fill_color, outline_color):
    ...
    def clone(self):
        ...
        self.v_rect = rg.Rectangle(self.v_rect.get_lower_right_corner(),self.v_rect.get_upper_left_corner())
        self.h_rect = rg.Rectangle(self.h_rect.get_lower_right_corner(),self.h_rect.get_upper_left_corner())
# ----------------------------------------------------------------------
